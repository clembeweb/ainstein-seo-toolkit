<div class="space-y-6">
    ...
    <div>
        ...
        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Crea un nuovo progetto di keyword research</p>
    </div>
            ...
            <form action="<?= url('/keyword-research/projects') ?>" method="POST" class="p-6 space-y-6">
                ...
                <div class="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-xl p-4">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h4 class="text-sm font-medium text-emerald-800 dark:text-emerald-200">Dopo la creazione potrai</h4>
                            <ul class="mt-1 text-sm text-emerald-700 dark:text-emerald-300 list-disc list-inside space-y-0.5">
                                <li>Avviare una Research Guidata con clustering AI</li>
                                <li>Progettare l'Architettura del Sito con AI</li>
                                <li>Esportare i risultati in CSV</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-200 dark:border-slate-700">
                    <a href="<?= url('/keyword-research/projects') ?>" class="px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white">
                        Annulla
                    </a>
