...
class Keyword
{
    ...
    public function create(array $data): int
    {
        ...
        // Aggiungi project_id se fornito (retrocompatibilita: null se non specificato)
    ...
    {
        return Database::count($this->table, 'user_id = ? AND project_id IS NOT NULL', [$userId]);
    }

    /**
     * Count keywords for project
     */
    ...
    public function allByProject(int $projectId, int $page = 1, int $perPage = 20): array
    {
        ...
        $data = Database::fetchAll($sql, [$projectId, $perPage, $offset]);
        $total = $this->countByProject($projectId);
