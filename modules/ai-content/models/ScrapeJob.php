 ...
 * ScrapeJob Model
 *
 * Gestisce la tabella aic_scrape_jobs per il tracking
 * dei job di scraping in background per i meta tag.
 * Pattern basato su seo-tracking/RankJob.php
 */
class ScrapeJob
{
    protected string $table = 'aic_scrape_jobs';
