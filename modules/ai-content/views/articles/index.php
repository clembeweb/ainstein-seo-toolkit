<div class="space-y-6" x-data="articlesManager()">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0 flex items-center gap-3">
            ...
            <a href="<?= url('/ai-content/keywords') ?>" class="inline-flex items-center px-4 py-2 rounded-lg bg-primary-600 text-white font-medium hover:bg-primary-700 transition-colors">
    ...
    <div class="flex flex-wrap gap-2">
        ...
        <a href="<?= url('/ai-content/articles?status=draft') ?>"
        ...
        <a href="<?= url('/ai-content/articles?status=generating') ?>"
        ...
        <a href="<?= url('/ai-content/articles?status=ready') ?>"
        ...
        <a href="<?= url('/ai-content/articles?status=published') ?>"
        ...
        <a href="<?= url('/ai-content/articles?status=failed') ?>"
                    ...
                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="min-w-0">
                                    <a href="<?= url('/ai-content/articles/' . $article['id']) ?>" class="font-medium text-slate-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-400 truncate block max-w-xs">
        ...
        <div class="px-6 py-4 border-t border-slate-200 dark:border-slate-700">
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="<?= url('/ai-content/articles?page=' . ($pagination['current_page'] - 1) . $queryParams) ?>"
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="mt-1 text-xs text-amber-600 dark:text-amber-400">
                                <a href="<?= url('/ai-content/wordpress') ?>" class="underline">Configura un sito WordPress</a> per pubblicare.
                            </p>
                            <?php endif; ?>
                        </div>
...
function articlesManager() {
    return {
        ...
        confirmDelete(id, title) {
            ...
            this.deleteUrl = '<?= url('/ai-content/articles') ?>/' + id + '/delete';
        ...
        async submitPublish() {
            ...
            try {
                const response = await fetch('<?= url('/ai-content/articles') ?>/' + this.publishId + '/publish', {
                    method: 'POST',
                    headers: {
        ...
        async regenerateArticle(id) {
            ...
            try {
                const response = await fetch('<?= url('/ai-content/articles') ?>/' + id + '/regenerate', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-Requested-With': 'XMLHttpRequest'
