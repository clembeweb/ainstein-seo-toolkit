                ...
                <template x-if="type === 'wordpress'">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="url" id="wp_url" name="wp_url" required
                                   class="w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white py-2.5 px-3 focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                        ...
                        <div>
                            ...
                            <input type="password" id="wp_api_key" name="wp_api_key" required
                                   class="w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white py-2.5 px-3 focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                ...
                <template x-if="type === 'shopify'">
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="shopify_store_url" name="shopify_store_url" required
                                   class="w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white py-2.5 px-3 focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                        ...
                        <div>
                            ...
                            <input type="password" id="shopify_access_token" name="shopify_access_token" required
                                   class="w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white py-2.5 px-3 focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                ...
                <template x-if="type === 'prestashop'">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="password" id="ps_api_key" name="ps_api_key" required
                                   class="w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white py-2.5 px-3 focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                ...
                <template x-if="type === 'magento'">
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="url" id="magento_url" name="magento_url" required
                                   class="w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white py-2.5 px-3 focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                   placeholder="https://www.myshop.com">
                        </div>
                        <div>
                            ...
                            <input type="password" id="magento_access_token" name="magento_access_token" required
                                   class="w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white py-2.5 px-3 focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
