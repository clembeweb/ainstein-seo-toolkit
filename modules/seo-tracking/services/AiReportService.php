...
class AiReportService
{
    ...
    public function generateWeeklyDigest(int $projectId, int $userId): ?array
    {
        ...
        $creditCost = Credits::getCost('weekly_digest', 'seo-tracking', 5);
    ...
    public function generateMonthlyExecutive(int $projectId, int $userId): ?array
    {
        ...
        $creditCost = Credits::getCost('monthly_executive', 'seo-tracking', 15);
    ...
    public function generateAnomalyAnalysis(int $projectId, int $userId, array $anomalyData): ?array
    {
        ...
        $creditCost = Credits::getCost('anomaly_detection', 'seo-tracking', 5);
    ...
    public function generateCustomReport(int $projectId, int $userId, string $type, ?string $customQuestion = null): ?array
    {
        ...
        // Costo basato sul tipo di report
        $creditCost = match($type) {
            'keyword_analysis' => Credits::getCost('keyword_analysis', 'seo-tracking', 5),
            'revenue_attribution' => Credits::getCost('revenue_attribution', 'seo-tracking', 8),
            default => Credits::getCost('keyword_analysis', 'seo-tracking', 5),
        };
