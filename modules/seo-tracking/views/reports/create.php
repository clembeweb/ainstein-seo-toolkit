<div class="space-y-6">
    ...
    <!-- Report Types -->
    <form action="<?= url('/seo-tracking/projects/' . $project['id'] . '/reports/generate') ?>" method="POST" id="generate-form">
        ...
        <div class="flex justify-end gap-4 mt-6">
            <a href="<?= url('/seo-tracking/projects/' . $project['id'] . '/reports') ?>" class="px-6 py-3 rounded-lg border border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 font-medium hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
                Annulla
            </a>
