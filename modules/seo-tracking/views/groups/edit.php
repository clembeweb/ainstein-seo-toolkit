<div class="space-y-6">
    ...
    <div class="flex items-center gap-3">
        <a href="<?= url('/seo-tracking/project/' . $project['id'] . '/groups/' . $group['id']) ?>" class="text-slate-400 hover:text-slate-600 dark:hover:text-slate-300">
    ...
    <!-- Form -->
    <form action="<?= url('/seo-tracking/project/' . $project['id'] . '/groups/' . $group['id'] . '/update') ?>" method="POST" class="space-y-6">
        ...
        <div class="flex items-center justify-end gap-3">
            <a href="<?= url('/seo-tracking/project/' . $project['id'] . '/groups/' . $group['id']) ?>" class="px-4 py-2 rounded-lg border border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 font-medium hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
                Annulla
            </a>
