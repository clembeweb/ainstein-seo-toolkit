<div class="space-y-6">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0">
            <a href="<?= url('/seo-tracking/projects/' . $project['id'] . '/export/revenue') ?>" class="inline-flex items-center px-3 py-2 rounded-lg border border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 text-sm font-medium hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
    ...
    <div class="border-b border-slate-200 dark:border-slate-700">
        <nav class="flex gap-6">
            ...
            <a href="<?= url('/seo-tracking/projects/' . $project['id'] . '/revenue') ?>" class="py-3 px-1 border-b-2 border-primary-500 text-primary-600 dark:text-primary-400 font-medium text-sm">
                Revenue
            </a>
        </nav>
    </div>
