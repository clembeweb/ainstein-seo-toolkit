        ...
        <form action="<?= url('/seo-audit/store') ?>" method="POST" class="p-6 space-y-6">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <label class="relative flex items-start p-4 border-2 border-slate-200 dark:border-slate-600 rounded-xl cursor-pointer hover:border-primary-400 dark:hover:border-primary-500 transition-colors has-[:checked]:border-primary-500 has-[:checked]:bg-primary-50 dark:has-[:checked]:bg-primary-900/20">
                        <input type="radio" name="crawl_mode" value="sitemap" class="mt-0.5 text-primary-600 focus:ring-primary-500">
                        <div class="ml-3">
                            <span class="block font-medium text-slate-900 dark:text-white">Sitemap</span>
                            <span class="text-xs text-slate-500 dark:text-slate-400">Usa solo sitemap.xml</span>
                        </div>
                    </label>
                    <label class="relative flex items-start p-4 border-2 border-slate-200 dark:border-slate-600 rounded-xl cursor-pointer hover:border-primary-400 dark:hover:border-primary-500 transition-colors has-[:checked]:border-primary-500 has-[:checked]:bg-primary-50 dark:has-[:checked]:bg-primary-900/20">
                        <input type="radio" name="crawl_mode" value="spider" class="mt-0.5 text-primary-600 focus:ring-primary-500">
                        <div class="ml-3">
                            <span class="block font-medium text-slate-900 dark:text-white">Spider</span>
                            <span class="text-xs text-slate-500 dark:text-slate-400">Segui i link interni</span>
                        </div>
                    </label>
                    <label class="relative flex items-start p-4 border-2 border-slate-200 dark:border-slate-600 rounded-xl cursor-pointer hover:border-primary-400 dark:hover:border-primary-500 transition-colors has-[:checked]:border-primary-500 has-[:checked]:bg-primary-50 dark:has-[:checked]:bg-primary-900/20">
                        <input type="radio" name="crawl_mode" value="both" checked class="mt-0.5 text-primary-600 focus:ring-primary-500">
                        <div class="ml-3">
                            <span class="block font-medium text-slate-900 dark:text-white">Entrambi</span>
                            <span class="text-xs text-slate-500 dark:text-slate-400">Sitemap + Spider (consigliato)</span>
                        </div>
                    </label>
                </div>
            </div>
