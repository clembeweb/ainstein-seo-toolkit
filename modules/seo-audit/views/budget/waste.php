...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-2 mb-6">
        ...
        <a href="<?= url($budgetUrl . '/waste') ?>" class="px-3 py-1.5 text-sm font-medium rounded-lg bg-primary-100 text-primary-700 dark:bg-primary-900/40 dark:text-primary-300">Pagine Spreco</a>
    ...
    <!-- Header -->
    <div>
        <h2 class="text-xl font-bold text-slate-900 dark:text-white">Pagine Spreco</h2>
    ...
    <div class="flex flex-wrap gap-2">
        ...
        <a href="<?= url($budgetUrl . '/waste?severity=critical') ?>"
        ...
        <a href="<?= url($budgetUrl . '/waste?severity=warning') ?>"
        ...
        <a href="<?= url($budgetUrl . '/waste?severity=notice') ?>"
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-12 text-center">
        ...
        <h3 class="text-lg font-semibold text-slate-900 dark:text-white">Nessuna pagina spreco</h3>
        <p class="mt-2 text-sm text-slate-500 dark:text-slate-400">
            <?php if (!empty($filters['severity'])): ?>
            Nessun risultato con i filtri selezionati.
            <?php else: ?>
            Non sono state rilevate pagine che sprecano crawl budget.
            <?php endif; ?>
        </p>
    </div>
    <?php else: ?>
