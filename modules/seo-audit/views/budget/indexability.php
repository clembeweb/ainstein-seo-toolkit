...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-2 mb-6">
        ...
        <a href="<?= url($budgetUrl . '/indexability') ?>" class="px-3 py-1.5 text-sm font-medium rounded-lg bg-primary-100 text-primary-700 dark:bg-primary-900/40 dark:text-primary-300">Indicizzabilit&agrave;</a>
    </div>

    <!-- Header -->
    <div>
        <h2 class="text-xl font-bold text-slate-900 dark:text-white">Problemi di Indicizzabilit&agrave;</h2>
    ...
    <div class="flex flex-wrap gap-2">
        ...
        <a href="<?= url($budgetUrl . '/indexability?severity=critical') ?>"
        ...
        <a href="<?= url($budgetUrl . '/indexability?severity=warning') ?>"
        ...
        <a href="<?= url($budgetUrl . '/indexability?severity=notice') ?>"
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-12 text-center">
        ...
        <h3 class="text-lg font-semibold text-slate-900 dark:text-white">Nessun problema di indicizzabilit&agrave;</h3>
        <p class="mt-2 text-sm text-slate-500 dark:text-slate-400">
            <?php if (!empty($filters['severity'])): ?>
            Nessun risultato con i filtri selezionati.
            <?php else: ?>
            Non sono stati rilevati problemi di indicizzabilit&agrave; nel crawl budget.
            <?php endif; ?>
        </p>
    </div>
    <?php else: ?>
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <?= \Core\View::partial('components/table-pagination', [
            ...
            'baseUrl' => url($budgetUrl . '/indexability'),
            'filters' => $filters,
        ]) ?>
    </div>
    <?php endif; ?>
