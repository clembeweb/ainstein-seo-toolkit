            ...
            <div x-show="activeTab === 'overview'" x-cloak>
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <?php if (!$page['is_indexable'] && $page['indexability_reason']): ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="p-3 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
                                <?php if ($page['has_schema'] && !empty($schemaTypes)): ?>
                                <div class="flex flex-wrap gap-2">
                                    <?php foreach ($schemaTypes as $type): ?>
                                    <span class="px-2 py-1 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 rounded text-xs"><?= e($type) ?></span>
                                    <?php endforeach; ?>
                                </div>
                                <?php else: ?>
                        ...
                        <div>
                            ...
                            <div class="p-3 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
                                ...
                                <ul class="space-y-1 text-sm">
                                    <?php foreach ($hreflangTags as $tag): ?>
                                    <li><span class="font-medium"><?= e($tag['lang']) ?>:</span> <?= e($tag['url']) ?></li>
                                    <?php endforeach; ?>
                                </ul>
                                <?php else: ?>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="p-3 bg-slate-50 dark:bg-slate-700/50 rounded-lg text-sm">
                                <?= date('d/m/Y H:i', strtotime($page['crawled_at'])) ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="p-4 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700/50">
                        <div class="flex items-start gap-3">
                            ...
                            <a href="<?= url('/seo-audit/project/' . $project['id'] . '/category/' . $issue['category']) ?>" class="text-xs text-slate-400 hover:text-primary-600">
