...
class Project
{
    ...
    {
        // Conta pagine
        $pagesCount = Database::count('sa_pages', 'project_id = ?', [$projectId]);
    ...
    public function getCrawlProgress(int $projectId): array
    {
        ...
        $pagesFound = (int) $project['pages_found'];
        $pagesCrawled = (int) $project['pages_crawled'];
