...
class GoogleOAuthService
{
    ...
    /**
     * Redirect URI centralizzato
     */
    public function getRedirectUri(): string
    {
        return $this->appUrl . '/oauth/google/callback';
    }
     ...
     */
    public function getAuthUrl(string $moduleSlug, int $projectId, string $scope = self::SCOPE_GSC): string
    {
