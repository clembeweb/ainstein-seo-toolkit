...
<div class="space-y-12">
    ...
    <section>
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                ...
                <div>
                    <h3 class="font-medium text-slate-900 dark:text-white">Crea un progetto e inserisci il dominio</h3>
                    <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">Specifica il dominio del sito che vuoi monitorare. Puoi gestire piu progetti contemporaneamente.</p>
                </div>
            ...
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                ...
                <div>
                    <h3 class="font-medium text-slate-900 dark:text-white">Connetti Google Search Console (OAuth)</h3>
                    <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">Collega il tuo account GSC per importare dati reali di click, impression, CTR e posizione media.</p>
                </div>
                <svg class="w-5 h-5 shrink-0 text-slate-300 dark:text-slate-600 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                ...
                <div>
                    <h3 class="font-medium text-slate-900 dark:text-white">Sincronizza i dati storici</h3>
                    <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">Importa fino a 16 mesi di storico da Google Search Console per avere subito una base dati completa.</p>
                </div>
                <svg class="w-5 h-5 shrink-0 text-slate-300 dark:text-slate-600 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h3 class="font-medium text-slate-900 dark:text-white text-sm">Google Search Console</h3>
                </div>
            ...
            <div class="p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h3 class="font-medium text-slate-900 dark:text-white text-sm">Gruppi di keyword</h3>
                </div>
            ...
            <div class="p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h3 class="font-medium text-slate-900 dark:text-white text-sm">Report AI</h3>
                </div>
    ...
    <section>
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-start gap-4 p-5 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/50">
                ...
                <div>
                    <h3 class="font-medium text-blue-900 dark:text-blue-200 text-sm">Configura gli alert per le keyword chiave</h3>
                    <p class="mt-1 text-sm text-blue-800 dark:text-blue-300/80">Imposta alert personalizzati sulle keyword piu importanti. Puoi definire soglie specifiche per calo posizioni e calo traffico, cosi da intervenire tempestivamente.</p>
                </div>
            </div>
            ...
            <div class="flex items-start gap-4 p-5 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/50">
                ...
                <div>
                    <h3 class="font-medium text-blue-900 dark:text-blue-200 text-sm">Sfrutta i Quick Wins</h3>
                    <p class="mt-1 text-sm text-blue-800 dark:text-blue-300/80">Il report Quick Wins identifica keyword posizionate tra la 4a e la 20a posizione con buon volume di ricerca: sono le opportunita a basso sforzo con il miglior rapporto costo-beneficio.</p>
                </div>
            </div>
            ...
            <div class="flex items-start gap-4 p-5 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/50">
                ...
                <div>
                    <h3 class="font-medium text-blue-900 dark:text-blue-200 text-sm">Connetti GA4 per il valore economico</h3>
                    <p class="mt-1 text-sm text-blue-800 dark:text-blue-300/80">Collegando Google Analytics 4 puoi vedere il valore economico reale delle tue keyword: revenue, conversioni e sessioni per landing page. Indispensabile per giustificare gli investimenti SEO.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="flex items-center justify-between pt-8 border-t border-slate-200 dark:border-slate-700">
        <a href="<?= url('/docs/seo-audit') ?>" class="inline-flex items-center gap-2 text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
            </svg>
            SEO Audit
        </a>
        <a href="<?= url('/docs/keyword-research') ?>" class="inline-flex items-center gap-2 text-sm font-medium text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors">
            Keyword Research
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
