...
<div class="space-y-12">
    ...
    <div>
        <div class="flex items-center gap-3 mb-4">
            ...
            <h1 class="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white">SEO Audit</h1>
        </div>
        <p class="text-sm text-slate-500 dark:text-slate-400">Analisi tecnica SEO completa con punteggio di salute e raccomandazioni AI</p>
    </div>
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">Specifica l'URL del sito che vuoi analizzare. Il sistema lo usera come base per il crawling.</p>
                </div>
            ...
            <div class="flex items-start gap-4 p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                ...
                <div>
                    <h3 class="font-medium text-slate-900 dark:text-white">Consulta la dashboard con il punteggio di salute</h3>
                    <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">Visualizza il punteggio complessivo 0-100 e la distribuzione dei problemi per severita: Critical, Warning e Notice.</p>
                </div>
                <svg class="w-5 h-5 shrink-0 text-slate-300 dark:text-slate-600 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h3 class="font-medium text-slate-900 dark:text-white text-sm">50+ controlli tecnici</h3>
                </div>
                <p class="text-sm text-slate-600 dark:text-slate-400">Meta tag, heading, immagini, link, contenuto, schema markup, mobile, sicurezza e altro ancora.</p>
            </div>
            ...
            <div class="p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h3 class="font-medium text-slate-900 dark:text-white text-sm">Punteggio salute 0-100</h3>
                </div>
            ...
            <div class="p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h3 class="font-medium text-slate-900 dark:text-white text-sm">Action Plan AI</h3>
                </div>
            ...
            <div class="p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 sm:col-span-2">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h3 class="font-medium text-slate-900 dark:text-white text-sm">Storico scansioni</h3>
                </div>
                <p class="text-sm text-slate-600 dark:text-slate-400">Ogni scansione viene archiviata automaticamente per confrontare l'evoluzione del sito nel tempo e misurare i miglioramenti.</p>
            </div>
        </div>
    </section>
    ...
    <section>
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-start gap-4 p-5 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/50">
                ...
                <div>
                    <h3 class="font-medium text-blue-900 dark:text-blue-200 text-sm">Dai priorita ai problemi Critical</h3>
                    <p class="mt-1 text-sm text-blue-800 dark:text-blue-300/80">I problemi Critical hanno il maggior impatto sul punteggio (-5 punti ciascuno) e sul posizionamento. Risolvili per primi per ottenere miglioramenti significativi e rapidi.</p>
                </div>
            </div>
    ...
    <div class="flex items-center justify-between pt-8 border-t border-slate-200 dark:border-slate-700">
        <a href="<?= url('/docs/ai-content') ?>" class="inline-flex items-center gap-2 text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
            </svg>
            AI Content Generator
        </a>
        <a href="<?= url('/docs/seo-tracking') ?>" class="inline-flex items-center gap-2 text-sm font-medium text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors">
            SEO Tracking
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
