...
<head>
    ...
    <title>403 - Accesso negato | Ainstein</title>
...
<body class="h-full bg-slate-50 dark:bg-slate-900">
    <main class="grid min-h-full place-items-center px-6 py-24 sm:py-32 lg:px-8">
        <div class="text-center">
            <div class="mx-auto h-16 w-16 rounded-2xl bg-red-100 dark:bg-red-900/30 flex items-center justify-center mb-6">
            ...
            <p class="text-base font-semibold text-red-600 dark:text-red-400">403</p>
            <h1 class="mt-2 text-3xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-4xl">Accesso negato</h1>
            <p class="mt-4 text-base leading-7 text-slate-600 dark:text-slate-400"><?= htmlspecialchars($message ?? 'Non hai i permessi per accedere a questa risorsa.') ?></p>
